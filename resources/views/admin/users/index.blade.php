                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="text-white-50 mb-0">{{ __('Manage Users') }}</p>
                        </div>
                        <div>
                            <button class="btn modern-btn-primary" id="addUser" data-bs-toggle="modal" data-bs-target="#addModal">
...
@push('scripts')
    {!! $dataTable->scripts() !!}
    <script src="{{ asset('admin/ajax/users.js?v=' . time()) }}"></script>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#table_filter input').attr('placeholder', '{{ __("Search Users") }}...');
...
@if(auth()->user()->hasRole('admin') || auth()->user()->hasPermission('user-add'))
@include('admin.users.create')
@endif
@if(auth()->user()->hasRole('admin') || auth()->user()->hasPermission('user-update'))
@include('admin.users.edit')
@endif
@if(auth()->user()->hasRole('admin') || auth()->user()->hasPermission('user-permission'))
