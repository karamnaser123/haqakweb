                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="text-white-50 mb-0">{{ __('Manage Categories') }}</p>
                        </div>
                        <div>
                            <button class="btn modern-btn-primary" id="addCategory" data-bs-toggle="modal" data-bs-target="#addModal">
...
@push('scripts')
    {!! $dataTable->scripts() !!}
    <script src="{{ asset('admin/ajax/categories.js?v=' . time()) }}"></script>
    ...
    <script>
        ...
        var routes = {
            ...
            update: '{{ route("categories.update") }}',
        ...
        $(document).ready(function() {
            ...
            $('#table_filter input').attr('placeholder', '{{ __("Search Categories") }}...');
...
@if(auth()->user()->hasRole('admin') || auth()->user()->hasPermission('category-add'))
@include('admin.categories.create')
@endif
@if(auth()->user()->hasRole('admin') || auth()->user()->hasPermission('category-update'))
