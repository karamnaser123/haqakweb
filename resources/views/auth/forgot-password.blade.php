...
<head>
    ...
    <title>{{ __('forgot_password') }} - {{ config('app.name', 'Laravel') }}</title>
...
<body>
    <div class="login-container">
        ...
        <div class="logo-section">
            ...
            <h1 class="welcome-title">{{ __('forgot_password') }}</h1>
            <p class="welcome-subtitle">{{ __('don_t_worry_we_will_help_you_to_reset_your_password') }}</p>
            <p class="description-text">
                {{ __('enter_email_and_send_link') }}
            </p>
        </div>
