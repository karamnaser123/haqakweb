...
<head>
    ...
    <title>إنشاء حساب جديد - {{ config('app.name', 'Laravel') }}</title>
...
<body>
    <div class="login-container">
        ...
        <div class="logo-section">
            ...
            <h1 class="welcome-title">إنشاء حساب جديد</h1>
            <p class="welcome-subtitle">انضم إلينا وابدأ رحلتك معنا</p>
            <p class="description-text">
                أنشئ حسابك الآن واستمتع بتجربة رائعة مع خدماتنا المتميزة
            </p>
        </div>
